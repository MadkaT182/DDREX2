...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor("JudgeRows")..{
		OnCommand=cmd(ztest,true;x,SCREEN_CENTER_X+192;y,SCREEN_CENTER_Y-9;cropbottom,.125);
	};
	Def.Quad{
	...
	LoadActor("stats")..{
		OnCommand=cmd(ztest,true;player,PLAYER_1;x,SCREEN_CENTER_X+127;y,SCREEN_CENTER_Y-80);
	};

	LoadActor("JudgeRows")..{
		OnCommand=cmd(ztest,true;x,SCREEN_CENTER_X-95;y,SCREEN_CENTER_Y-87;croptop,.875);
	};
...
-- t[#t+1] = Def.ActorFrame {
-- 	LoadActor("NewRecord")..{
-- 		OnCommand=cmd(glowshift;effectcolor1,1,1,0,.5;effectcolor2,1,1,0,0;effectperiod,.5;x,SCREEN_LEFT-212;y,SCREEN_CENTER_Y+52;sleep,.868;decelerate,.2;x,SCREEN_CENTER_X-102);
