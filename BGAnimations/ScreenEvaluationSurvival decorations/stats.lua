...
local Combo = string.format("% 4d",STATSMAN:GetAccumPlayedStageStats():GetPlayerStageStats(PLAYER_1):MaxCombo());
...
t[#t+1] = Def.ActorFrame{
	...
	LoadFont("ScreenEvaluation judge")..{
		InitCommand=cmd(x,-142;y,SCREEN_CENTER_Y-63;horizalign,right);
		OnCommand=function(self)
			self:settext(Combo);
		end;
	};
