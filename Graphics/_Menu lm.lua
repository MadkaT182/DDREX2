...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/lm")..{
		OnCommand=cmd(x,xInit;y,-19;diffuse,color("#FFFF00");sleep,.234;linear,.167;x,xPos;linear,.167;addx,-13;);
