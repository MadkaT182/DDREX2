...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor("_menu/_op/op")..{
		OnCommand=cmd(y,62;x,-13;diffuse,color("#FFFF00"));
		OffCommand=cmd();
	};
...
--Title
t[#t+1] = LoadActor("_menu/_tit/op")..{
	OnCommand=cmd(x,261;y,143);
	OffCommand=cmd();
};

--Description
t[#t+1] = LoadActor("_menu/_desc/op")..{
	OnCommand=cmd(x,251;y,189);
	OffCommand=cmd();
};

--Art
t[#t+1] = LoadActor("_menu/_art/op")..{
