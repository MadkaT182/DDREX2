...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/op")..{
		OnCommand=cmd(x,xInit;y,62;diffuse,color("#FFFF00");sleep,.317;linear,.167;x,xPos;linear,.167;addx,-13;);
