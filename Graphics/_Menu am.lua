...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/am")..{
		OnCommand=cmd(x,xInit;y,-46;diffuse,color("#FFFF00");sleep,.217;linear,.167;x,xPos;linear,.167;addx,-13;);
