...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/sh")..{
		OnCommand=cmd(x,xInit;y,143;diffuse,color("#FFFF00");sleep,.401;linear,.167;x,xPos;linear,.167;addx,-13;);
