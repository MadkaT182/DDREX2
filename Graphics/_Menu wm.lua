...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/wm")..{
		OnCommand=cmd(x,xInit;y,-73;diffuse,color("#FFFF00");sleep,.201;linear,.167;x,xPos;linear,.167;addx,-13;);
