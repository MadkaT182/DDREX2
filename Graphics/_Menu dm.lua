...
return Def.ActorFrame {
	LoadActor("_menu/_op/dm")..{
		OnCommand=cmd(x,xInit;y,-127;diffuse,color("#FFFF00");sleep,.167;linear,.167;x,xPos;linear,.167;addx,-13;);
