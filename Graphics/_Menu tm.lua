...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/tm")..{
		OnCommand=cmd(x,xInit;y,8;diffuse,color("#FFFF00");sleep,.267;linear,.167;x,xPos;linear,.167;addx,-13;);
