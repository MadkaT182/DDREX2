...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/re")..{
		OnCommand=cmd(x,xInit;y,89;diffuse,color("#FFFF00");sleep,.334;linear,.167;x,xPos;linear,.167;addx,-13;);
