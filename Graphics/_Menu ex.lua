...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/ex")..{
		OnCommand=cmd(x,xInit;y,170;diffuse,color("#FFFF00");sleep,.434;linear,.167;x,xPos;linear,.167;addx,-13;);
