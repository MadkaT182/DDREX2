...
t[#t+1] = Def.ActorFrame {
	...
	LoadActor("_menu/_op/fp")..{
		OnCommand=cmd(y,-100);
		OffCommand=cmd(sleep,.184;linear,.167;x,xInit);
	};
	...
	LoadActor("_menu/_op/ex")..{
		OnCommand=cmd(y,170;x,-13;diffuse,color("#FFFF00"));
