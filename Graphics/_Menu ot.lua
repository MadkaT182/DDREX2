...
return Def.ActorFrame {
	...
	LoadActor("_menu/_op/ot")..{
		OnCommand=cmd(x,xInit;y,116;diffuse,color("#FFFF00");sleep,.367;linear,.167;x,xPos;linear,.167;addx,-13;);
